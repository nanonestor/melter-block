package com.nanonestor.melter.foundation.render;
...
public class RenderTypes extends RenderStateShard {
	...
	private static class Shaders {
		...
		public static void onRegisterShaders(RegisterShadersEvent event) throws IOException {
			...
			event.registerShader(new ShaderInstance(resourceManager, Melter.asResource("glowing_shader"), DefaultVertexFormat.NEW_ENTITY), shader -> glowingShader = shader);
		}*/
	}
