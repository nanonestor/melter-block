package com.nanonestor.melter.foundation.fluid;
...
import com.nanonestor.melter.foundation.utility.RegisteredObjects;
	...
	public static FluidStack deserializeFluidStack(JsonObject json) {
		...
		try {
			...
			stack.setTag(TagParser.parseTag(
				element.isJsonObject() ? Melter.GSON.toJson(element) : GsonHelper.convertToString(element, "nbt")));
