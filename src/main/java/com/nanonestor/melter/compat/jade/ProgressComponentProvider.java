package com.nanonestor.melter.compat.jade;
...
public class ProgressComponentProvider  implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    ...
    public void appendServerData(CompoundTag compoundTag, BlockAccessor accessor) {
        if(accessor.getBlockEntity() instanceof MelterBlockEntity){
            MelterBlockEntity melter = (MelterBlockEntity) accessor.getBlockEntity();
