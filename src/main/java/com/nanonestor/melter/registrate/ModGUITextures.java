...
import com.nanonestor.melter.foundation.gui.UIRenderHelper;
import com.nanonestor.melter.foundation.gui.element.ScreenElement;
import com.nanonestor.melter.foundation.utility.Color;
...
public enum ModGUITextures implements ScreenElement {
    ...
    private ModGUITextures(String location, int startX, int startY, int width, int height) {
        this("melter", location, startX, startY, width, height);
    }
